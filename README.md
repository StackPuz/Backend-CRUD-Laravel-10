# Boilerplate-CRUD-Laravel-10
Boilerplate CRUD Web App created with Laravel 10 by [StackPuz](https://stackpuz.com).
...
## Installation
1. Clone this repository. `git clone https://github.com/stackpuz/Boilerplate-CRUD-Laravel-10.git .`
